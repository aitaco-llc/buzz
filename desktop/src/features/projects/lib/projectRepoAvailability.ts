...
> = {
  authentication: {
    description:
      "aitaco could not authenticate with this repository. Check your access and try again.",
    title: "Repository access failed",
  },
  missing: {
    description:
      "The project announcement exists, but its git repository was not found on the aitaco relay.",
  ...
  network: {
    description:
      "The aitaco git service could not be reached. Check your connection and try again.",
  ...
  unknown: {
    description:
      "aitaco could not load this repository. Try again or contact the project owner.",
