...
pub(super) const PRESET_HARNESSES: &[PresetHarness] = &[
    PresetHarness {
        ...
        install_hint: "Requires Node.js 22 or newer. Install the Pi ACP adapter with `npm install -g --install-links=true 'git+https://github.com/salman1993/buzz-pi-acp.git#86b201e'`. Make sure `buzz-pi-acp` is on PATH, then restart aitaco.",
    ...
    PresetHarness {
        ...
        install_hint: "aitaco talks to Devin through the official Devin CLI's ACP mode (devin acp).",
        underlying_cli: None,
    ...
    PresetHarness {
        ...
        install_hint: "aitaco talks to Cursor through the cursor-agent CLI's ACP mode.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to Oh My Pi through its CLI's ACP mode (omp acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to Grok Build through its CLI's agent stdio mode.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to OpenCode through its CLI's ACP mode (opencode acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to Kimi Code through its CLI's ACP mode (kimi acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to the Amp CLI through the amp-acp adapter. Follow the setup guide to install the adapter so the amp-acp command is on your PATH.",
    ...
    PresetHarness {
        ...
        install_hint: "aitaco talks to Hermes Agent through its hermes-acp command.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "aitaco talks to OpenClaw through its ACP mode (openclaw acp), which relies on the OpenClaw Gateway daemon. Follow the setup guide to install both.\n\n\
...
mod tests {
    ...
    fn pi_preset_uses_zero_arg_adapter_and_reports_missing_component() {
        ...
        assert_eq!(
            ...
            "Requires Node.js 22 or newer. Install the Pi ACP adapter with `npm install -g --install-links=true 'git+https://github.com/salman1993/buzz-pi-acp.git#86b201e'`. Make sure `buzz-pi-acp` is on PATH, then restart aitaco."
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            "Install Pi with `npm install -g @earendil-works/pi-coding-agent`, then run `pi` to configure its model provider. Requires Node.js 22 or newer. Install the Pi ACP adapter with `npm install -g --install-links=true 'git+https://github.com/salman1993/buzz-pi-acp.git#86b201e'`. Make sure `buzz-pi-acp` is on PATH, then restart aitaco."
        );
    }
