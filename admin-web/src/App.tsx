...
import aitacoMark from "./assets/aitaco-mark.png";
...
function Reports({ authMode }: { authMode: AuthMode }) {
  ...
  return (
    <Page
      eyebrow="Moderation"
      title="Open reports"
      description="Review reports across every aitaco community."
    >
...
function FeedbackList({ authMode }: { authMode: AuthMode }) {
  ...
  return (
    <Page
      eyebrow="Product"
      title="Feedback"
      description="Recent product feedback from across aitaco."
    >
      <StateView resource={resource}>
        {(items) => {
